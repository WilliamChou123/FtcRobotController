...
public class Constants {
    ...
    public static ThreeWheelIMUConfig localizerConfig = new ThreeWheelIMUConfig(c -> {
        c.leftEncoderName.set("lr");
        c.rightEncoderName.set("rr");
        c.strafeEncoderName.set("lf");
        c.imuName.set("imu");
        c.imu.set(new RevHubIMU(
                new RevHubOrientationOnRobot(
                        RevHubOrientationOnRobot.LogoFacingDirection.RIGHT,
                        RevHubOrientationOnRobot.UsbFacingDirection.UP
                )
        ));
        c.leftPodY.set(4.599793307249445);
        c.rightPodY.set(-4.5468003810015087);
        c.strafePodX.set(10.860261699700615);
        c.forwardTicksToInches.set(0.0020001998841974082);
        c.strafeTicksToInches.set(-0.0029658443558684);
        c.turnTicksToRadians.set(0.003232450816849083);
